...
public class BasePage 
{
	...
	public WebDriver getDriver()
	{
		...
		// mvn clean package -Dremotewebdriver="192.168.1.17:4448" -Dtestngfile="testng_surefire_8.xml" -Dbrowser="CHROME"		
		...
		//ENTRYPOINT java -jar HybridFramework-0.0.1-SNAPSHOT-jar-with-dependencies.jar $remotewebdriver $testngfile $browser

        //docker run -e remotewebdriver=192.168.1.17:4448 -e testngfile=testng_surefire_8.xml -e browser=CHROME skdocker/selenium-docker
		...
		System.out.println("RemoteWebDriver URL : " + "http://"+ host +":4444/wd/hub");
		...
		{	
			try {
				...
				capability.setPlatform(Platform.LINUX);
			     ...
			     driver = new RemoteWebDriver(new URL("http://"+ host +":4444/wd/hub"), capability);				
				 driver.manage().timeouts().implicitlyWait(pageTimeOutWait, TimeUnit.SECONDS);
				 driver.manage().window().maximize();
				 driver.manage().timeouts().pageLoadTimeout(pageTimeOutWait, TimeUnit.SECONDS);				
			} catch (MalformedURLException e) 
